---
sidebar_position: 2
sidebar_label: "Week 2: Window Wonders"
title: "Week 2: Window Wonders & Folder Forts"
description: "Learn to navigate the Windows desktop, manage windows, and organize files and folders."
---
...
> **Learning Objectives:** Identify Desktop, Taskbar, Start Menu; open apps; use window controls (min/max/close); arrange windows.
...
- "What does the 'X' button do on a window?"
- "How can you find a program if it's not on the taskbar?"

---

## Guided Session 2: Building File Homes

> **Learning Objectives:** Define file/folder (analogy); open File Explorer; navigate; create/name new folder; create sub-folders; use 'Save As'; save Notepad file to specific folder.
...
- "Why is it helpful to put files into folders?"
- "What does 'Save As' let us do that 'Save' doesn't always do?" (Choose location/name first time)
- "What's one thing you can try if something isn't working right?"

---

## Independent Session: "Folder Fun"
