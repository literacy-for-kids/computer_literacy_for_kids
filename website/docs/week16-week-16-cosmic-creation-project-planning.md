---
sidebar_position: 16
sidebar_label: "Week 16: Cosmic Creation"
title: "Week 16: Cosmic Creation - Project Planning"
description: "Students define their final project goal, brainstorm and outline a Digital Creation Story, and begin creating assets with their chosen tools."
---
...
> **Learning Objectives:** Define final project goal ("Digital Creation Story"); brainstorm/discuss story ideas based on interests; select one idea; create simple 3-part story outline (Notepad); identify appropriate software tools for components.
...
- "What's the story we decided to tell?"
- "What tools are we planning to use?"

---

## Guided Session 2: Building the Universe — Asset Creation

> **Learning Objectives:** Create dedicated project folder; begin creating initial digital assets (images, code, models) based on plan/tools; practice using tools purposefully; save assets into project folder with descriptive names.
...
- "What did we create for our story today?"
- "Why is saving in the project folder important?"

---

## Independent Session: "Project Work Time"
