---
sidebar_position: 11
sidebar_label: "Week 11: AI Adventures"
title: "Week 11: AI Adventures & Smart Sparks"
description: "Students are introduced to AI chatbots, learn safe interaction practices, and explore creative and critical uses of AI tools."
---
...
"AI like ChatGPT can sometimes help us brainstorm ideas for stories, like our final project. But remember, we always need to check facts it gives us!"
:::
...
> **Learning Objectives:** Define AI simply (pattern-learning program); interact safely with chatbot ([ChatGPT](https://chat.openai.com/)) under supervision; understand AI is tool, not person; reiterate no sharing private info.
...
- "Is ChatGPT a person or a computer program?"
- "What kind of information should we *never* share with it?"

---

## Guided Session 2: Creative & Critical AI Use

> **Learning Objectives:** Use AI for creative brainstorming; understand AI can be wrong ("hallucinate"); practice verifying AI facts with trusted source; know to ask adult if AI response is weird/wrong.
...
- "How can AI help us be creative?"
- "Why is it important to check facts the AI gives us?"

---

## Independent Session: "AI Idea Spark"
